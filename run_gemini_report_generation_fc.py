...
# Ensure the directory containing coinw_functions_for_gemini can be found
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

# Attempt to import the functions and their declarations
try:
    from coinw_functions_for_gemini import (
        GET_COINW_OHLCV_DATA_DECLARATION,
        GET_COINW_FUNDING_RATE_DECLARATION,
        GET_COINW_LONG_SHORT_RATIO_DECLARATION,
        get_coinw_ohlcv_data,
        get_coinw_funding_rate_data,
        get_coinw_long_short_ratio_data
    )
    AVAILABLE_FUNCTIONS = {
        "get_coinw_ohlcv_data": get_coinw_ohlcv_data,
        "get_coinw_funding_rate_data": get_coinw_funding_rate_data,
        "get_coinw_long_short_ratio_data": get_coinw_long_short_ratio_data
    }
    TOOL_DECLARATIONS = [
        GET_COINW_OHLCV_DATA_DECLARATION,
        GET_COINW_FUNDING_RATE_DECLARATION,
    ...
    print("Successfully imported CoinW functions for Gemini.")
except ImportError as e:
    print(f"Error importing CoinW functions: {e}. Ensure coinw_functions_for_gemini.py is in the same directory or PYTHONPATH.")
    AVAILABLE_FUNCTIONS = {}
    TOOL_DECLARATIONS = []
...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        print("Error: Tool declarations or available functions for Gemini are missing. Check coinw_functions_for_gemini.py import.")
    else:
        ...
        if not os.path.exists(args.prompt_file):
            ...
            template_file = "/home/ubuntu/user_llm_prompt_template.md"
